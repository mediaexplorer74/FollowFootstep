...
namespace monogameJam
{
  public class Composant : Element2D
  {
    ...
    public virtual void BouteilleTexte(bool open)
    {
      ...
      {
        this.bouteilleImage = (ATHComposite) new ATHCompositeImage((ATH) null, new Vector2(0.0f, 0.0f), new Vector2(700f, 300f), "map", Ancre.center);
        Program.game.Components.Add((IGameComponent) this.bouteilleImage);
        this.bouteilleImage.add((ATH) new ATHFeuilleText((ATH) this.bouteilleImage, new Vector2(0.0f, -100f), new Vector2(0.0f, 0.0f), "Hey honey, It's dad. I m seriously injured ", new Color(0, 0, 0), 2f, Ancre.center));
        this.bouteilleImage.add((ATH) new ATHFeuilleText((ATH) this.bouteilleImage, new Vector2(0.0f, 0.0f), new Vector2(0.0f, 0.0f), "somewhere dangerous and I need your help ! ", new Color(0, 0, 0), 2f, Ancre.center));
        this.bouteilleImage.add((ATH) new ATHFeuilleText((ATH) this.bouteilleImage, new Vector2(0.0f, 100f), new Vector2(0.0f, 0.0f), "Please bring me the medkit and be careful !", new Color(0, 0, 0), 2f, Ancre.center));
      }
      else
      {
        if (open)
