  ...
  public abstract class Etat
  {
    ...
    public virtual void ActionObjet()
    {
      ...
      Rectangle rectangle1 = new Rectangle(
          this.Joueur.Hitbox().X - 20, 
          this.Joueur.Hitbox().Y - 20, 
          this.Joueur.Hitbox().Width + 40,
          this.Joueur.Hitbox().Height + 40);

      for (int index = 0; c == null && index < Game1.game.Carte.Composants.Count; ++index)
      {
        if ((Game1.game.Carte.Composants[index].Type == Type.TPoussable 
                    || Game1.game.Carte.Composants[index].Type == Type.TPortable
                    || Game1.game.Carte.Composants[index].Type == Type.TBouteille) 
                    && Game1.game.Carte.Composants[index].Afficher 
                    && this.Joueur != Game1.game.Carte.Composants[index] 
                    && rectangle1.Intersects(Game1.game.Carte.Composants[index].Hitbox()))
          c = Game1.game.Carte.Composants[index];
      }
