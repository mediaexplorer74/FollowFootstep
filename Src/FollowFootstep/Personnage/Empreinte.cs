  ...
  public class Empreinte : Element2D
  {
    ...
    public override void Draw(GameTime gameTime)
    {
      Rectangle destinationRectangle =
                ...
                - (double) Program.game.Joueur.Position.X
                - (double) Program.game.Joueur.Taille.X / 2.0 
                + (double) (this.Game.GraphicsDevice.PresentationParameters.BackBufferWidth / 2)),
                (int) ((double) this.position.Y - (double) Program.game.Joueur.Position.Y
                - (double) Program.game.Joueur.Taille.X / 2.0 
